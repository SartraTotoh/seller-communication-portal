# Seller Communication Portal v4.8.5 — Source Mapping

## Architecture

v4.8.5 uses three read-only operational sources and one Portal-owned database.
...
## v4.8.5 deployment-source note
No PN/SCA/Social mapping or Asset Approval business rule changed in v4.8.5. This release only strengthens Apps Script source/policy synchronization and immutable source attestation before deployment.
